 ...
 */
//if (Configure::read('debug')) {
  // Plugin::load('debug_kit', ['bootstrap' => true]);
//}
 Plugin::loadAll();
Plugin::load('Bootstrap', ['bootstrap' => true]);


Plugin::load('wyrihaximus/twig-view', ['bootstrap' => true]);
...
//Configure::write('Users.reCaptcha.key', ' 6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI');
//Configure::write('Users.reCaptcha.secret', '6LeIxAcTAAAAAGG-vFI1TnRWxMZNFuojJ4WifJWe');
