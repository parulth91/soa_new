...
class ActivityListsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['WeightCategoryLists', 'GenderLists', 'GameTypesLists', 'AgeGroupLists']
        ];
    ...
    public function add()
    {
        ...
        $weightCategoryLists = $this->ActivityLists->WeightCategoryLists->find('list', ['keyField' => 'id', 'valueField' => 'maximum_weight'])->where(['is_active'=>true])->order('description');
         $weightCategoryLists1 = $this->ActivityLists->WeightCategoryLists->find('list', ['keyField' => 'id', 'valueField' => 'minimum_weight'])->where(['is_active'=>true])->order('description');        
        $genderLists = $this->ActivityLists->GenderLists->find('list', ['keyField' => 'id', 'valueField' => 'description'])->where(['is_active'=>true])->order('description');
        $gameTypesLists = $this->ActivityLists->GameTypesLists->find('list', ['keyField' => 'id', 'valueField' => 'description'])->where(['is_active'=>true])->order('description');
        $ageGroupLists = $this->ActivityLists->AgeGroupLists->find('list', ['keyField' => 'id', 'valueField' => 'maximum_age'])->where(['is_active'=>true])->order('description');
         $ageGroupLists1 = $this->ActivityLists->AgeGroupLists->find('list', ['keyField' => 'id', 'valueField' => 'minimum_age'])->where(['is_active'=>true])->order('description');
        $this->set(compact('activityList', 'weightCategoryLists', 'genderLists', 'gameTypesLists', 'ageGroupLists','ageGroupLists1','weightCategoryLists1'));
    }
    ...
    public function edit($id = null)
    {
        ...
        $gameTypesLists = $this->ActivityLists->GameTypesLists->find('list', ['keyField' => 'id', 'valueField' => 'description'])->where(['active'=>true])->order('description');
        ...
        $this->set(compact('activityList', 'weightCategoryLists', 'genderLists', 'gameTypesLists', 'ageGroupLists'));
    }
