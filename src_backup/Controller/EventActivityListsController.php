...
class EventActivityListsController extends AppController
{
    ...
    public function add()
    {
        ...
        $eventLists = $this->EventActivityLists->EventLists->find('list', ['keyField' => 'id', 'valueField' => 'description'])->where(['is_active'=>true])->order('description');
        $activityLists = $this->EventActivityLists->ActivityLists->find('list', ['keyField' => 'id', 'valueField' => 'description'])->where(['is_active'=>true])->order('description');
