 ...
 <li>
  ...
  <li>
            ...
            <ul class="collapse list-unstyled" id="GameTypesLists">
                <li><?= $this->Html->link(__('Game type List'), ['controller' => 'GameTypesLists', 'action' => 'index']) ?> </li>
                <li><?= $this->Html->link(__('New Game type'), ['controller' => 'GameTypesLists', 'action' => 'add']) ?> </li>
