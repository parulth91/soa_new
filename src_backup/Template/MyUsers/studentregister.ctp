...
<!-- Pen Title-->
        <div class="pen-title">
            <h3 align="center">Registration for <?php 
               print_r($Result[0]['event_list']->description);//die;?> 
            </h3>
       </div>
          ...
          if(max_fields ==1 || max_fields =='')
           ...
           if(x < max_fields){ //max input box allowed
                       ...
                       if(x >1)
                        ...
                        //text box increment
                       $(wrapper).append(
                         '<br/><div class=col-md-3><?= $this->Form->input('first_name[]', 
                           ['type' => 'text',
                            'label' => false, 
                ...
                $(wrapper).append('<div class=col-md-3><?= $this->Form->input('last_name[]', 
                           ['type' => 'text',
                            'label' => false, 
