...
//        $query = " select * from total_count_view";
    ...
    public function studentRegister($id = null) {
        ...
        $registerCandidate = $this->RegisterCandidates->newEntity();
 ...
 debug($this->request->data);die;
            ...
            debug($registerCandidateEventActivity);die;
        ...
        $genderLists = $this->RegisterCandidates->GenderLists->find('list', ['keyField' => 'id', 'valueField' => 'description'])->where(['active' => true])->order('description');
