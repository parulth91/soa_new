...
<div class="panel panel-default">
    ...
    <table class="table table-striped" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td><?= __('Game Type List') ?></td>
            <td><?= $activityList->has('game_type_list') ? $this->Html->link($activityList->game_type_list->description, ['controller' => 'GameTypeLists', 'action' => 'view', $activityList->game_type_list->id]) : '' ?></td>
        </tr>
        <tr>
