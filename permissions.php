    ...
    'CakeDC/Auth.permissions' => [
        ...
        [
           ...
           'controller' => ['MyUsers','Pages','EmployeeInformations'],
            'action' => ['index','instruction','contactUs','locationMatrix','usersDetail','myList','profile', 'logout', 'login' ],
        ],
        ...
        [
            ...
            'plugin' => '*',
            'controller' => ['MyUsers','Pages','EmployeeInformations'],
            'action' => ['index','editUsers','instruction','contactUs','locationMatrix','usersDetail','myList','profile', 'logout', 'login' ],
        ],
        ...
        [
            ...
            'plugin' => '*',
            'controller' => ['MyUsers','Pages','EmployeeInformations'],
            'action' => ['index', 'add','edit','instruction','contactUs','locationMatrix','usersDetail','myList','profile', 'logout', 'login' ],
        ],
        [
            'role' => 'soUnit',
            'prefix' => '*',
            ...
            'plugin' => '*',
            'controller' => ['MyUsers','Pages','EmployeeInformations'],
            'action' => ['index','edit','instruction','contactUs','locationMatrix','usersDetail','myList','profile', 'logout', 'login' ],
        ],
        [
            'role' => 'mainUnit',
            'prefix' => '*',
